...
This is the GitHub repo for Rosetta's React/Redux front-end. The repo for the Flask back-end micro-service can be found at https://github.com/rosetta-team/rosetta-be.
